<?php
//fake mail sender
//please don't be that spam\phishing guy because this mails are spoofed but most mail services will mark them as spam 
//because they come from non "legit" dns servers
// Fnzv,
...
<div >
<?php echo $mail; ?>
<form action="mailspoof.php" method="post">
<table style='color:00FF00' border="0">
<tr>
<td> To: </td>
